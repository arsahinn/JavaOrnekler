...
public class test {
    ...
    public static void sarkici_ekle() {
        ...
        System.out.println("Eklemek İstediginiz Sarkicinin İsmi:");
    ...
    public static void sarkici_guncelle() {
        ...
        System.out.println("Guncellemek istediginiz pzoisyon(1,2,3,4....)");
    ...
    public static void sil() {
        ...
        System.out.println("Silmek istediginiz pozisyon (1,2,3,4....)");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\t Sarkıcı Uygulamasına Hosgeldınız....");
